...
namespace UnityBuilderAction
{
    ...
    public static class BuildScript
    {
        ...
        private static string COMPANY_NAME = "1696617274806403592369";
        ...
        private static string KEYSTORE_PASS = "akandatanghariyangindah";
        private static string KEY_ALIAS_NAME = "akandatanghariyangindah";
        private static string KEY_ALIAS_PASS = "akandatanghariyangindah";
